...
public class AppConfig {
    ...
    public DataSource dataSource() {
        ...
        dataSource.setUrl("jdbc:mysql://localhost:3306/tsubasa_session11?createDatabaseIfNotExist=true&useSSL=false");
    ...
    public Cloudinary cloudinary(){
        Map<String , String> config = ObjectUtils.asMap(
                "cloud_name", "dqe768y7y",
                "api_key", "589482873653755",
                "api_secret", "m-tkhWoqRymQ__e-k0d2FLGwOV0"
        );
